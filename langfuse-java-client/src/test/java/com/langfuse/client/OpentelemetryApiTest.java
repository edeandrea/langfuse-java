...
/**
 * Integration tests for the OpenTelemetry API.
 *
...
abstract class OpentelemetryApiTest extends AbstractLangfuseClientTest {
    ...
    void exportTraces() {
                ...
                .resource(OtelResource.builder()
                        .attributes(List.of(
                                OtelAttribute.builder()
                                        ...
                                        .value(OtelAttributeValue.builder()
                                                .stringValue("otel-export-test")
                                                .build())
                                        .build(),
                                OtelAttribute.builder()
                                        .key("service.name")
                                        .value(OtelAttributeValue.builder()
                                                .stringValue("langfuse-java-test")
                                                .build())
                                        .build()))
                        .build())
                .scopeSpans(List.of(OtelScopeSpan.builder()
                        .scope(OtelScope.builder()
                                .name("langfuse-java-test")
                                .version("1.0.0")
                                .build())
                        .spans(List.of(span))
                        .build()))
        ...
        assertThat(client.opentelemetry().opentelemetryExportTraces(
