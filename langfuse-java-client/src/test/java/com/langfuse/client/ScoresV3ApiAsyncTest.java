...
class ScoresV3ApiAsyncTest extends AbstractLangfuseClientTest {
    ...
    private static final String SCORE_NAME = "async-v3-score-" + UUID.randomUUID().toString().substring(0, 8);
